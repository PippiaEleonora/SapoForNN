...
if [[ $REPLY =~ ^[Yy]$ ]]
then
python3 . --netname DATA/exp555.tf --domain refinepoly --epsilon 0.1 --sparse_n 3 \
--refine_neurons --num_test 1
printf "\n\n"
fi
...
sleep 2
python3 . --netname DATA/exp555.tf --domain refinepoly --epsilon 0.1 --sparse_n 3 \
--refine_neurons --num_test 1 --sanity_check 0
printf "\n\n"
printf ""
fi
...
printf "\nrest: default\n\n "
sleep 2
python3 . --netname DATA/exp555.tf --domain refinepoly --epsilon 0.1 --sparse_n 1 \
...
printf "\nrest: default\n\n "
sleep 2
python3 . --netname DATA/exp555.tf --domain refinepoly --epsilon 0.1 --sparse_n 2 \
--refine_neurons --num_test 1 --sanity_check 1 --splitting 1 --lower_bound -5 \
--upper_bound 5 
fi
...
printf "\n with splitting before (Experiment 1). The results are shown below for comparison. "
